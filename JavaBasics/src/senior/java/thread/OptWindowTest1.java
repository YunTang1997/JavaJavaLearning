 ...
 *
 * }
 * 说明：1.操作[共享数据]的代码，即为需要被同步的代码。  -->不能包含代码多了，也不能包含代码少了。
 ...
 * @author YunTang
 * @create 2020-07-26 15:50
 */


public class OptWindowTest1 {
...
//    Object obj = new Object();
    ...
    public void run() {
        ...
        while (true){
            synchronized (this) { // 锁必须是同一个，此时的this：唯一的Window2的对象；方式二：synchronized (obj)
                if (tickets > 0) {
